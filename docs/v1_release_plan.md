...
| AI Supervisor | In progress | DeepSeek/OpenAI adapter, local fallback, structured decisions | Add decision logging and high-value news review discipline |
